    ...
    setup(props) {
        ...
        return () =>
            h("div", {
                ...
                h("div", {
                    class: "text-4xl font-bold mb-5 portrait:text-5xl"
                }, forecast.value.dayOfWeek),
                h("div" , {
                    class: "flex flex-row items-center"
                }, [
                    h("i", {
                        class: "text-7xl mr-5 portrait:text-8xl " + forecast.value.icon
                    }),
                    h("div", {
                        class: "flex flex-col text-4xl portrait:text-5xl"
                    }, [
                        h("div", {
                            class: "font-bold"
